...
const heroTextContent = 'Awwlii mah Love';
...
const quotes = [
    "IDK how IDK why but all the tym we spend together",
    "J make meh feel better than ever",
    "I love to hear yer rant and wanna know about your day",
    "I really love the way you walk, talk, listen, help and stay tgt wid meh",
    "lips on lips, till morning alarm",
    "Even if you feel low, I will always be there mah love",
    "You are the reason I WAKE UP WID MORNING SMILE",
    "ALISON SHERWOOD GIVING MEH MORNING WOOD EH."
 ];
